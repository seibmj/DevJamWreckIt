package com.caterpillar.wreckitrampage.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("wreckItRampage");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("wreckItRampage");
        ...
        config.getMapConfigs().put("com.caterpillar.wreckitrampage.domain.*", initializeDomainMapConfig(jHipsterProperties));
